            ...
            Surface(
                ...
                Row(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(
                            text = "Targeted Weak-Spot · Q ${currentQIndex + 1}/${activeQuestions.size}",
                            fontSize = 13.sp,
            ...
            LazyColumn(
                ...
                if (currentQuestion != null) {
                        ...
                        Row(
                            ...
                            Surface(
                                ...
                                Row(
                                    ...
                                    Text(
                                        text = "FOCUS: ${currentQuestion.topic.uppercase()} · ${currentQuestion.subtopic}",
                                        fontSize = 10.sp,
                                        fontWeight = FontWeight.Bold,
                                        color = ChemOrange
                                    )
                            ...
                            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                                currentQuestion.options.forEachIndexed { index, optionText ->
                                    ...
                                    val optionBg = when {
                                        ...
                                        isSelected -> ChemOrange.copy(alpha = 0.15f)
                                    ...
                                    Surface(
                                        ...
                                        modifier = Modifier
                                            ...
                                            .clickable(enabled = !isAnswered) {
                                                ...
                                                viewModel.submitWeakSpotOption(index)
                                            }
                                            .testTag("weak_opt_$index")
                                    ) {
                                        Row(
                                            ...
                                            Surface(
                                                shape = RoundedCornerShape(6.dp),
                                                color = if (isSelected) ChemOrange else MaterialTheme.colorScheme.surface,
                    ...
                    if (isAnswered && feedbackMessage.isNotBlank()) {
                        item {
                            FeedbackCard(
                                ...
                                message = if (isFeedbackCorrect) "Weak Spot Resolved!" else "Concept Mastery Guide",
                    ...
                    if (isAnswered) {
                        item {
                            ChemPrimaryButton(
                                text = if (currentQIndex + 1 >= activeQuestions.size) "FINISH WEAK-SPOTS PRACTICE →" else "NEXT WEAK-SPOT QUESTION →",
                                onClick = { viewModel.nextWeakSpotQuestion() },
                                accentColor = ChemOrange,
                                modifier = Modifier.fillMaxWidth(),
                                testTag = "next_weak_btn"
                            )
